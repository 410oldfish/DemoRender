...
*/
  ...
  //绑定FrameBuffer，设置视口大小，清除颜色和深度缓冲区
  ...
  uint32_t OpenGL_FrameBuffer::get_texture()//获取的是颜色缓冲区的已经被写入好的纹理
  {
    return mTexId;
  }
